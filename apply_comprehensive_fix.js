...
async function main() {
    try {
        ...
        console.log("RECREATING COMPREHENSIVE dim_schools VIEW...");
        const sql = `
        ...
        const res = await pool.query("SELECT column_name FROM information_schema.columns WHERE table_name = 'dim_schools' AND column_name IN ('schoolname', 'region', 'school_type', 'curricular_offering', 'totalenrolment')");
